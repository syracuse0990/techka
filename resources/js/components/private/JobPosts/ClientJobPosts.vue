...
const tableHeaders = reactive([
   { title: 'TITLE', onSet: true, sortable: true, query: 'full_name', date_filtered: false, searchable: true, checked: true, hasInlineEdit: true, textAlign: 'left', columnWidth: 'w-64' },
   { title: 'AMOUNT', onSet: true, sortable: false, query: 'email', date_filtered: false, searchable: true, checked: true, hasInlineEdit: false, textAlign: 'left', columnWidth: 'w-64' },
   { title: 'Duration', onSet: false, sortable: false, query: 'phone', date_filtered: false, searchable: true, checked: false, hasInlineEdit: false, textAlign: 'left' },
   ...
   { title: 'STATUS', onSet: true, sortable: true, query: 'online', date_filtered: true, searchable: false, checked: false, hasInlineEdit: true, textAlign: 'left' },
