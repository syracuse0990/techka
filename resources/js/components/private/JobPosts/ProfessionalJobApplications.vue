<template>
    <div class="mt-3 mb-5">
       <h2 class="text-primary font-semibold text-xl">Manage My Job Applications</h2>
   </div>
...
const tableHeaders = reactive([
   { title: 'CLIENT', onSet: true, sortable: true, query: 'full_name', date_filtered: false, searchable: true, checked: true, hasInlineEdit: true, textAlign: 'left', columnWidth: 'w-64' },
   { title: 'Job Title', onSet: true, sortable: false, query: 'email', date_filtered: false, searchable: true, checked: true, hasInlineEdit: false, textAlign: 'left', columnWidth: 'w-64' },
   { title: 'Task Amount', onSet: true, sortable: true, query: 'role', date_filtered: false, searchable: true, checked: false, hasInlineEdit: false, textAlign: 'left' },
   { title: 'Status', onSet: false, sortable: false, query: 'phone', date_filtered: false, searchable: true, checked: false, hasInlineEdit: false, textAlign: 'left' },
